...
const Maincontent = () => {
  ...
  return (
    <div id ="creators" className=' ' >
         <div  className ='  w-full h-[132vh]  rounded-1xl  bg-black' >
        <div className='  w-full    m-auto max-w-[1140px] text-white '>
         ...
         <div className='card   w-[300px] bg-white text-black rounded-2xl border-2 h-[440px] border-slate-700' >
         ...
         <div className=' mt-14  card w-[300px] bg-white text-black rounded-2xl border-2 h-[440px] border-slate-700'>
         ...
         <div className=' my-28  card w-[300px] bg-white text-black rounded-2xl border-2 h-[440px] border-slate-700'>
          ...
          <button className='  text-white   mx-2 px-4 mt-20  '>GET STARTED</button>
         </div>
         </div>
