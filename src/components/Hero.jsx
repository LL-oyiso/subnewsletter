  ...
  return ( 
    ...
    <div className =' w-full  h-[90vh]  rounded-1xl' >
      ...
      <div className='max-w-[1140px] m-auto  '>
        <div className='absolute top-[40%] w-full md:-[50%] max-w-[900px] h-full flex flex-col text-white p-4'>
          <h1 className=' text-7xl font-bold text-black font-[KronaOne]  '>Welcome to a world where we build cool shit</h1>
          <h2 className='text-4xl py-4 italic  text-black rotate-45'>Hello</h2>
